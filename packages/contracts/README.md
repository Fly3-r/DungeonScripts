...
- package metadata and manifests may also include an optional `discordURL` so the catalog can link to a Discord discussion thread when a package provides one
